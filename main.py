...
button_chooser = Button(root, text="Click me to choose a scale!", font=30, command=lambda: [scale.update_scale(label_randomized_scale), scale.show_scale(label_scale)])
